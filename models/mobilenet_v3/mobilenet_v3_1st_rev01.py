...
def mobilenet_1st_floor(image_folder= 'crop/'):
    predictions = []
    ...
    # 저장된 모델 가중치 불러오기
    # pth_path = 'weight/mobilenet_v3/1st_floor/mobilenet_v3_1st_rev00.pth'
    pth_path = 'weight/mobilenet_v3/1st_floor/mobilenet_v3_1st_rev01.pth'
    # pth_path = 'weight/mobilenet_v3/3rd_floor/mobilenet_v3_rev07.pth'
    # pth_path = '/mnt/d/burr/make_pth_train_test/model_weights/best_model.pth'
